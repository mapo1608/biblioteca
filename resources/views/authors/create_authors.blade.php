...
<style>
    ...
    .btn-medieval-submit {
        background-color: #007bff !important; /* Blu per l'aggiunta */
...
<div class="create-background">
    <div class="create-card">
        ...
        {{-- TITOLO PRINCIPALE --}}
        <h1 class="text-center display-6 medieval-font text-info mb-5">
            ISCRIZIONE DI UN NUOVO AUTORE
        </h1>

        <form action="{{ route('authors.store') }}" method="POST" class="my-2">
            @csrf
